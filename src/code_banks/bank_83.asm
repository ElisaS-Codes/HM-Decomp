...
;;;;;;;; This seems to be unused, not called anywhere
UNK_Audio26: ;8382C6
        %Set8bit(!M)
        %Set16bit(!X)                        
        PHA                                  
...
;;;;;;;; Seems to be unused
UNK_IncreaseTransitionPointer: ;838376
        %Set8bit(!M)                         
        LDA.W $0103                          
        INC A                                
        STA.W $0103                          
...
UNK_Audio_Table7: dw $02EC,$02EC,$0272,$03AB,$02B6,$0443,$0399,$02AD;838F4F
                  dw $01F6,$0260,!inputstate,$018E,$01D1,$0293,$023D,$02F2
...
;;;;;;;;
          CODE_8392BB: %Set16bit(!MX)                             ;8392BB;      ; 
                       %Set16bit(!M)                             ;8392BD;      ; 
                       LDA.W #$CB05                         ;8392BF;      ; 
                       STA.B $72                            ;8392C2;000072; 
                       LDA.W #$2000                         ;8392C4;      ; 
                       STA.B $75                            ;8392C7;000075; 
                       %Set8bit(!M)                             ;8392C9;      ; 
                       LDA.B #$A5                           ;8392CB;      ; 
                       STA.B $74                            ;8392CD;000074; 
                       LDA.B #$7E                           ;8392CF;      ; 
                       STA.B $77                            ;8392D1;000077; 
                       JSL.L DecompressTileMap           ;8392D3;8381F8; 
                       %Set8bit(!M)                             ;8392D7;      ; 
                       LDA.B #$00                           ;8392D9;      ; 
                       STA.B !ProgDMA_Channel_Index                            ;8392DB;000027; 
                       LDA.B #$18                           ;8392DD;      ; 
                       STA.B !ProgDMA_Destination_Memory                            ;8392DF;000029; 
                       %Set16bit(!MX)                             ;8392E1;      ; 
                       LDY.W #$0400                         ;8392E3;      ; 
                       LDX.W #$7800                         ;8392E6;      ; 
                       LDA.W #$2000                         ;8392E9;      ; 
                       STA.B $72                            ;8392EC;000072; 
                       %Set8bit(!M)                             ;8392EE;      ; 
                       LDA.B #$7E                           ;8392F0;      ; 
                       STA.B $74                            ;8392F2;000074; 
                       %Set16bit(!M)                             ;8392F4;      ; 
                       LDA.W #$0080                         ;8392F6;      ; 
                       JSL.L AddProgrammedDMA                ;8392F9;808A33; 
                       JSL.L StartLastPreparedDMA               ;8392FD;808AB2; 
                       %Set8bit(!M)                             ;839301;      ; 
                       LDA.B #$00                           ;839303;      ; 
                       STA.B !ProgDMA_Channel_Index                            ;839305;000027; 
                       LDA.B #$18                           ;839307;      ; 
                       STA.B !ProgDMA_Destination_Memory                            ;839309;000029; 
                       %Set16bit(!MX)                             ;83930B;      ; 
                       LDA.W #$5000                         ;83930D;      ; 
                       TAX                                  ;839310;      ; 
                       LDY.W #$1000                         ;839311;      ; 
                       LDA.W #$BBA3                         ;839314;      ; 
                       STA.B $72                            ;839317;000072; 
                       %Set8bit(!M)                             ;839319;      ; 
                       LDA.B #$9C                           ;83931B;      ; 
                       STA.B $74                            ;83931D;000074; 
                       %Set16bit(!M)                             ;83931F;      ; 
                       LDA.W #$0080                         ;839321;      ; 
                       JSL.L AddProgrammedDMA                ;839324;808A33; 
                       JSL.L StartLastPreparedDMA               ;839328;808AB2; 
                       RTL                                  ;83932C;      ; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
          CODE_83932D: %Set8bit(!M)                             ;83932D;      ; 
                       LDA.B #$06                           ;83932F;      ; 
                       STA.B !ProgDMA_Channel_Index                            ;839331;000027; 
                       LDA.B #$18                           ;839333;      ; 
                       STA.B !ProgDMA_Destination_Memory                            ;839335;000029; 
                       %Set16bit(!MX)                             ;839337;      ; 
                       LDA.W #$5000                         ;839339;      ; 
                       TAX                                  ;83933C;      ; 
                       LDY.W #$0C00                         ;83933D;      ; 
                       LDA.W #$BBA3                         ;839340;      ; 
                       STA.B $72                            ;839343;000072; 
                       %Set8bit(!M)                             ;839345;      ; 
                       LDA.B #$9C                           ;839347;      ; 
                       STA.B $74                            ;839349;000074; 
                       %Set16bit(!M)                             ;83934B;      ; 
                       LDA.W #$0080                         ;83934D;      ; 
                       JSL.L AddProgrammedDMA                ;839350;808A33; 
                       %Set8bit(!M)                             ;839354;      ; 
                       LDA.B #$07                           ;839356;      ; 
                       STA.B !ProgDMA_Channel_Index                            ;839358;000027; 
                       JSL.L RemoveProgrammedDMA                    ;83935A;808AA0; 
                       RTL                                  ;83935E;      ; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
          ...
          CODE_8393F9: %Set8bit(!M)                             ;8393F9;      ; 
                       ...
                       JSL.L CODE_83932D                    ;839421;83932D; 
                       %Set16bit(!M)                             ;839425;      ; 
...
CheckSRAMIntegrity: ;83BAD4
    ...
    .check2Passed:
        RTL
          ...
          CODE_83BC5A: %Set16bit(!MX)                             ;83BC5A;      ; 
                       LDA.L $7F1F60                        ;83BC5C;7F1F60; 
                       AND.W #$0001                         ;83BC60;      ; 
                       BEQ CODE_83BC68                      ;83BC63;83BC68; 
                       JMP.W CODE_83BE4B                    ;83BC65;83BE4B; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
          CODE_83BC68: LDX.W #$0000                         ;83BC68;      ; 
                                                            ;      ;      ; 
          CODE_83BC6B: %Set16bit(!MX)                             ;83BC6B;      ; 
                       PHX                                  ;83BC6D;      ; 
                       PHX                                  ;83BC6E;      ; 
                       TXA                                  ;83BC6F;      ; 
                       JSL.L GetsCowPointer                ;83BC70;83C9A7; 
                       %Set8bit(!M)                             ;83BC74;      ; 
                       %Set16bit(!X)                             ;83BC76;      ; 
                       PLX                                  ;83BC78;      ; 
                       LDY.W #$0000                         ;83BC79;      ; 
                       LDA.B [$72],Y                        ;83BC7C;000072; 
                       AND.B #$01                           ;83BC7E;      ; 
                       BNE CODE_83BC85                      ;83BC80;83BC85; 
                       JMP.W CODE_83BE3F                    ;83BC82;83BE3F; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
          CODE_83BC85: %Set8bit(!M)                             ;83BC85;      ; 
                       LDY.W #$0000                         ;83BC87;      ; 
                       LDA.B [$72],Y                        ;83BC8A;000072; 
                       AND.B #$02                           ;83BC8C;      ; 
                       BEQ CODE_83BC93                      ;83BC8E;83BC93; 
                       JMP.W CODE_83BE3F                    ;83BC90;83BE3F; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
          CODE_83BC93: LDY.W #$0000                         ;83BC93;      ; 
                       LDA.B [$72],Y                        ;83BC96;000072; 
                       AND.B #$04                           ;83BC98;      ; 
                       BEQ CODE_83BC9F                      ;83BC9A;83BC9F; 
                       JMP.W CODE_83BE2E                    ;83BC9C;83BE2E; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
          CODE_83BC9F: LDY.W #$0002                         ;83BC9F;      ; 
                       LDA.B [$72],Y                        ;83BCA2;000072; 
                       CMP.B #$27                           ;83BCA4;      ; 
                       BNE CODE_83BCD3                      ;83BCA6;83BCD3; 
                       LDY.W #$0000                         ;83BCA8;      ; 
                       LDA.B [$72],Y                        ;83BCAB;000072; 
                       AND.B #$40                           ;83BCAD;      ; 
                       BNE CODE_83BCC2                      ;83BCAF;83BCC2; 
                       %Set16bit(!M)                             ;83BCB1;      ; 
                       TXA                                  ;83BCB3;      ; 
                       ASL A                                ;83BCB4;      ; 
                       TAX                                  ;83BCB5;      ; 
          ...
          CODE_83BCC2: %Set16bit(!MX)                             ;83BCC2;      ; 
                       ...
                       JMP.W CODE_83BD9E                    ;83BCD0;83BD9E; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
          CODE_83BCD3: %Set8bit(!M)                             ;83BCD3;      ; 
                       %Set16bit(!X)                             ;83BCD5;      ; 
                       LDY.W #$0002                         ;83BCD7;      ; 
                       LDA.B [$72],Y                        ;83BCDA;000072; 
                       CMP.B #$04                           ;83BCDC;      ; 
                       BCS CODE_83BD10                      ;83BCDE;83BD10; 
                       JSL.L CKKKK                          ;83BCE0;82A9A0; 
                       %Set16bit(!M)                             ;83BCE4;      ; 
                       LDA.W $092E                          ;83BCE6;00092E; 
                       BEQ CODE_83BD10                      ;83BCE9;83BD10; 
                       %Set16bit(!M)                             ;83BCEB;      ; 
                       LDA.W $0196                          ;83BCED;000196; 
                       AND.W #$0002                         ;83BCF0;      ; 
                       BNE CODE_83BD10                      ;83BCF3;83BD10; 
                       LDA.W $0196                          ;83BCF5;000196; 
                       AND.W #$0008                         ;83BCF8;      ; 
                       BNE CODE_83BD20                      ;83BCFB;83BD20; 
                       LDA.W $0196                          ;83BCFD;000196; 
                       AND.W #$0010                         ;83BD00;      ; 
                       BNE CODE_83BD30                      ;83BD03;83BD30; 
                       LDA.W $0196                          ;83BD05;000196; 
                       AND.W #$0200                         ;83BD08;      ; 
                       BNE CODE_83BD40                      ;83BD0B;83BD40; 
                       JMP.W CODE_83BD9E                    ;83BD0D;83BD9E; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
          ...
          CODE_83BD40: %Set16bit(!M)                             ;83BD40;      ; 
                       ...
                       BRA CODE_83BD50                      ;83BD4E;83BD50; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
          CODE_83BD50: %Set16bit(!MX)                             ;83BD50;      ; 
                       TYA                                  ;83BD52;      ; 
                       JSL.L RNGReturn0toA                  ;83BD53;8089F9; 
                       BNE CODE_83BD9E                      ;83BD57;83BD9E; 
                       %Set8bit(!M)                             ;83BD59;      ; 
                       %Set16bit(!X)                             ;83BD5B;      ; 
                       LDY.W #$0000                         ;83BD5D;      ; 
                       LDA.B [$72],Y                        ;83BD60;000072; 
                       AND.B #$40                           ;83BD62;      ; 
                       BNE CODE_83BD9E                      ;83BD64;83BD9E; 
                       LDY.W #$0001                         ;83BD66;      ; 
                       LDA.B [$72],Y                        ;83BD69;000072; 
                       AND.B #$80                           ;83BD6B;      ; 
                       BNE CODE_83BD9E                      ;83BD6D;83BD9E; 
                       LDY.W #$0000                         ;83BD6F;      ; 
                       LDA.B [$72],Y                        ;83BD72;000072; 
                       AND.B #$20                           ;83BD74;      ; 
                       BNE CODE_83BD9E                      ;83BD76;83BD9E; 
                       %Set8bit(!M)                             ;83BD78;      ; 
                       %Set16bit(!X)                             ;83BD7A;      ; 
                       LDY.W #$0000                         ;83BD7C;      ; 
                       LDA.B [$72],Y                        ;83BD7F;000072; 
                       ORA.B #$20                           ;83BD81;      ; 
                       STA.B [$72],Y                        ;83BD83;000072; 
                       LDY.W #$0003                         ;83BD85;      ; 
                       LDA.B #$07                           ;83BD88;      ; 
                       ...
                       JSL.L AddPlayerHappiness                   ;83BD9A;83B282; 
                                                            ;      ;      ; 
          CODE_83BD9E: %Set8bit(!M)                             ;83BD9E;      ; 
                       %Set16bit(!X)                             ;83BDA0;      ; 
                       LDY.W #$0005                         ;83BDA2;      ; 
                       LDA.B [$72],Y                        ;83BDA5;000072; 
                       CMP.B #$0A                           ;83BDA7;      ; 
                       BEQ CODE_83BDEB                      ;83BDA9;83BDEB; 
                       %Set16bit(!M)                             ;83BDAB;      ; 
                       LDA.L $7F1F5A                        ;83BDAD;7F1F5A; 
                       AND.W #$1000                         ;83BDB1;      ; 
                       BEQ CODE_83BDD6                      ;83BDB4;83BDD6; 
                       %Set8bit(!M)                             ;83BDB6;      ; 
                       LDY.W #$0002                         ;83BDB8;      ; 
                       LDA.B [$72],Y                        ;83BDBB;000072; 
                       CMP.B #$27                           ;83BDBD;      ; 
                       BEQ CODE_83BE3F                      ;83BDBF;83BE3F; 
                       %Set8bit(!M)                             ;83BDC1;      ; 
                       LDA.B #$10                           ;83BDC3;      ; 
                       JSL.L RNGReturn0toA                  ;83BDC5;8089F9; 
                       ...
                       BRA CODE_83BDEB                      ;83BDD4;83BDEB; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
          CODE_83BDD6: %Set16bit(!M)                             ;83BDD6;      ; 
                       LDA.W $0196                          ;83BDD8;000196; 
                       AND.W #$0400                         ;83BDDB;      ; 
                       BEQ CODE_83BE3F                      ;83BDDE;83BE3F; 
                       %Set8bit(!M)                             ;83BDE0;      ; 
                       LDY.W #$0002                         ;83BDE2;      ; 
                       LDA.B [$72],Y                        ;83BDE5;000072; 
                       CMP.B #$27                           ;83BDE7;      ; 
                       BEQ CODE_83BE3F                      ;83BDE9;83BE3F; 
                                                            ;      ;      ; 
          CODE_83BDEB: %Set8bit(!M)                             ;83BDEB;      ; 
                       %Set16bit(!X)                             ;83BDED;      ; 
                       LDY.W #$0000                         ;83BDEF;      ; 
                       LDA.B [$72],Y                        ;83BDF2;000072; 
                       AND.B #$40                           ;83BDF4;      ; 
                       BNE CODE_83BE3F                      ;83BDF6;83BE3F; 
                       LDY.W #$0001                         ;83BDF8;      ; 
                       LDA.B [$72],Y                        ;83BDFB;000072; 
                       AND.B #$80                           ;83BDFD;      ; 
                       BNE CODE_83BE3F                      ;83BDFF;83BE3F; 
                       LDY.W #$0000                         ;83BE01;      ; 
                       LDA.B [$72],Y                        ;83BE04;000072; 
                       AND.B #$20                           ;83BE06;      ; 
                       BNE CODE_83BE3F                      ;83BE08;83BE3F; 
                       %Set8bit(!M)                             ;83BE0A;      ; 
                       LDY.W #$0000                         ;83BE0C;      ; 
                       LDA.B [$72],Y                        ;83BE0F;000072; 
                       ORA.B #$10                           ;83BE11;      ; 
                       STA.B [$72],Y                        ;83BE13;000072; 
                       LDY.W #$0003                         ;83BE15;      ; 
                       LDA.B #$03                           ;83BE18;      ; 
                       STA.B [$72],Y                        ;83BE1A;000072; 
                       LDY.W #$0005                         ;83BE1C;      ; 
                       LDA.B #$00                           ;83BE1F;      ; 
                       ...
                       BRA CODE_83BE3F                      ;83BE2C;83BE3F; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
          CODE_83BE2E: %Set8bit(!M)                             ;83BE2E;      ; 
                       %Set16bit(!X)                             ;83BE30;      ; 
                       LDY.W #$0002                         ;83BE32;      ; 
                       LDA.B [$72],Y                        ;83BE35;000072; 
                       CMP.B #$04                           ;83BE37;      ; 
                       BCS CODE_83BE3F                      ;83BE39;83BE3F; 
                       JSL.L CKKKK                          ;83BE3B;82A9A0; 
                                                            ;      ;      ; 
          CODE_83BE3F: %Set16bit(!MX)                             ;83BE3F;      ; 
                       PLX                                  ;83BE41;      ; 
                       INX                                  ;83BE42;      ; 
                       CPX.W #$000C                         ;83BE43;      ; 
                       BEQ CODE_83BE4B                      ;83BE46;83BE4B; 
                       JMP.W CODE_83BC6B                    ;83BE48;83BC6B; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
          CODE_83BE4B: %Set16bit(!MX)                             ;83BE4B;      ; 
                       LDA.L $7F1F6E                        ;83BE4D;7F1F6E; 
                       AND.W #$EFBF                         ;83BE51;      ; 
                       STA.L $7F1F6E                        ;83BE54;7F1F6E; 
                       LDX.W #$0000                         ;83BE58;      ; 
                                                            ;      ;      ; 
          CODE_83BE5B: %Set16bit(!MX)                             ;83BE5B;      ; 
                       PHX                                  ;83BE5D;      ; 
                       PHX                                  ;83BE5E;      ; 
                       TXA                                  ;83BE5F;      ; 
                       JSL.L GetsCowPointer                ;83BE60;83C9A7; 
                       %Set8bit(!M)                             ;83BE64;      ; 
                       %Set16bit(!X)                             ;83BE66;      ; 
                       PLX                                  ;83BE68;      ; 
                       LDY.W #$0000                         ;83BE69;      ; 
                       LDA.B [$72],Y                        ;83BE6C;000072; 
                       AND.B #$01                           ;83BE6E;      ; 
                       BNE CODE_83BE75                      ;83BE70;83BE75; 
                       JMP.W CODE_83C01A                    ;83BE72;83C01A; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
          CODE_83BE75: LDY.W #$0004                         ;83BE75;      ; 
                       LDA.B [$72],Y                        ;83BE78;000072; 
                       %Set8bit(!M)                             ;83BE7A;      ; 
                       %Set16bit(!X)                             ;83BE7C;      ; 
                       LDY.W #$0001                         ;83BE7E;      ; 
                       LDA.B [$72],Y                        ;83BE81;000072; 
                       AND.B #$F8                           ;83BE83;      ; 
                       STA.B [$72],Y                        ;83BE85;000072; 
                       LDY.W #$0000                         ;83BE87;      ; 
                       LDA.B [$72],Y                        ;83BE8A;000072; 
                       AND.B #$02                           ;83BE8C;      ; 
                       BEQ CODE_83BEB1                      ;83BE8E;83BEB1; 
                       LDY.W #$0003                         ;83BE90;      ; 
                       LDA.B [$72],Y                        ;83BE93;000072; 
                       INC A                                ;83BE95;      ; 
                       STA.B [$72],Y                        ;83BE96;000072; 
                       CMP.B #$0E                           ;83BE98;      ; 
                       BEQ CODE_83BE9F                      ;83BE9A;83BE9F; 
                       JMP.W CODE_83C01A                    ;83BE9C;83C01A; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
          CODE_83BE9F: LDA.B #$00                           ;83BE9F;      ; 
                       STA.B [$72],Y                        ;83BEA1;000072; 
                       LDY.W #$0000                         ;83BEA3;      ; 
                       LDA.B [$72],Y                        ;83BEA6;000072; 
                       ORA.B #$04                           ;83BEA8;      ; 
                       AND.B #$FD                           ;83BEAA;      ; 
                       STA.B [$72],Y                        ;83BEAC;000072; 
                       JMP.W CODE_83C01A                    ;83BEAE;83C01A; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
          CODE_83BEB1: %Set8bit(!M)                             ;83BEB1;      ; 
                       %Set16bit(!X)                             ;83BEB3;      ; 
                       LDY.W #$0000                         ;83BEB5;      ; 
                       LDA.B [$72],Y                        ;83BEB8;000072; 
                       AND.B #$04                           ;83BEBA;      ; 
                       BEQ CODE_83BEF5                      ;83BEBC;83BEF5; 
                       %Set8bit(!M)                             ;83BEBE;      ; 
                       LDY.W #$0003                         ;83BEC0;      ; 
                       LDA.B [$72],Y                        ;83BEC3;000072; 
                       INC A                                ;83BEC5;      ; 
                       STA.B [$72],Y                        ;83BEC6;000072; 
                       CMP.B #$15                           ;83BEC8;      ; 
                       BEQ CODE_83BECF                      ;83BECA;83BECF; 
                       JMP.W CODE_83C01A                    ;83BECC;83C01A; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
          CODE_83BECF: LDA.B #$00                           ;83BECF;      ; 
                       STA.B [$72],Y                        ;83BED1;000072; 
                       LDY.W #$0000                         ;83BED3;      ; 
                       LDA.B [$72],Y                        ;83BED6;000072; 
                       ORA.B #$08                           ;83BED8;      ; 
                       AND.B #$FB                           ;83BEDA;      ; 
                       STA.B [$72],Y                        ;83BEDC;000072; 
                       LDY.W #$0003                         ;83BEDE;      ; 
                       LDA.B #$00                           ;83BEE1;      ; 
                       STA.B [$72],Y                        ;83BEE3;000072; 
                       %Set16bit(!M)                             ;83BEE5;      ; 
                       LDA.L $7F1F6E                        ;83BEE7;7F1F6E; 
                       ORA.W #$1000                         ;83BEEB;      ; 
                       STA.L $7F1F6E                        ;83BEEE;7F1F6E; 
                       JMP.W CODE_83C01A                    ;83BEF2;83C01A; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
          CODE_83BEF5: %Set16bit(!MX)                             ;83BEF5;      ; 
                       LDA.L $7F1F6E                        ;83BEF7;7F1F6E; 
                       ORA.W #$1000                         ;83BEFB;      ; 
                       STA.L $7F1F6E                        ;83BEFE;7F1F6E; 
                       %Set8bit(!M)                             ;83BF02;      ; 
                       LDY.W #$0000                         ;83BF04;      ; 
                       LDA.B [$72],Y                        ;83BF07;000072; 
                       AND.B #$10                           ;83BF09;      ; 
                       BEQ CODE_83BF26                      ;83BF0B;83BF26; 
                       LDY.W #$0003                         ;83BF0D;      ; 
                       LDA.B [$72],Y                        ;83BF10;000072; 
                       DEC A                                ;83BF12;      ; 
                       STA.B [$72],Y                        ;83BF13;000072; 
                       BEQ CODE_83BF1A                      ;83BF15;83BF1A; 
                       JMP.W CODE_83C01A                    ;83BF17;83C01A; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
          CODE_83BF1A: LDY.W #$0000                         ;83BF1A;      ; 
                       LDA.B [$72],Y                        ;83BF1D;000072; 
                       AND.B #$EF                           ;83BF1F;      ; 
                       STA.B [$72],Y                        ;83BF21;000072; 
                       JMP.W CODE_83C01A                    ;83BF23;83C01A; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
          CODE_83BF26: %Set8bit(!M)                             ;83BF26;      ; 
                       %Set16bit(!X)                             ;83BF28;      ; 
                       LDY.W #$0000                         ;83BF2A;      ; 
                       LDA.B [$72],Y                        ;83BF2D;000072; 
                       AND.B #$20                           ;83BF2F;      ; 
                       BEQ CODE_83BF87                      ;83BF31;83BF87; 
                       LDY.W #$0003                         ;83BF33;      ; 
                       LDA.B [$72],Y                        ;83BF36;000072; 
                       BEQ CODE_83BF42                      ;83BF38;83BF42; 
                       DEC A                                ;83BF3A;      ; 
                       STA.B [$72],Y                        ;83BF3B;000072; 
                       BEQ CODE_83BF42                      ;83BF3D;83BF42; 
                       JMP.W CODE_83C01A                    ;83BF3F;83C01A; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
          CODE_83BF42: %Set16bit(!MX)                             ;83BF42;      ; 
                       LDA.W $0196                          ;83BF44;000196; 
                       AND.W #$001A                         ;83BF47;      ; 
                       BEQ CODE_83BF4F                      ;83BF4A;83BF4F; 
                       JMP.W CODE_83C01A                    ;83BF4C;83C01A; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
          CODE_83BF4F: %Set8bit(!M)                             ;83BF4F;      ; 
                       LDA.W !weather_tomorrow                          ;83BF51;00098C; 
                       CMP.B #$06                           ;83BF54;      ; 
                       BCC CODE_83BF5B                      ;83BF56;83BF5B; 
                       JMP.W CODE_83C01A                    ;83BF58;83C01A; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
          CODE_83BF5B: %Set8bit(!M)                             ;83BF5B;      ; 
                       LDY.W #$0000                         ;83BF5D;      ; 
                       LDA.B #$00                           ;83BF60;      ; 
                       STA.B [$72],Y                        ;83BF62;000072; 
                       %Set8bit(!M)                             ;83BF64;      ; 
                       LDA.L !cow_N                        ;83BF66;7F1F0A; 
                       DEC A                                ;83BF6A;      ; 
                       STA.L !cow_N                        ;83BF6B;7F1F0A; 
                       %Set16bit(!M)                             ;83BF6F;      ; 
                       LDA.L $7F1F6E                        ;83BF71;7F1F6E; 
                       ORA.W #$0040                         ;83BF75;      ; 
                       STA.L $7F1F6E                        ;83BF78;7F1F6E; 
                       PLX                                  ;83BF7C;      ; 
                       PHX                                  ;83BF7D;      ; 
                       TXA                                  ;83BF7E;      ; 
                       %Set8bit(!M)                             ;83BF7F;      ; 
                       STA.W $0937                          ;83BF81;000937; 
                       JMP.W CODE_83C01A                    ;83BF84;83C01A; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
          CODE_83BF87: %Set8bit(!M)                             ;83BF87;      ; 
                       %Set16bit(!X)                             ;83BF89;      ; 
                       LDY.W #$0001                         ;83BF8B;      ; 
                       LDA.B [$72],Y                        ;83BF8E;000072; 
                       AND.B #$80                           ;83BF90;      ; 
                       BEQ CODE_83BFAA                      ;83BF92;83BFAA; 
                       %Set8bit(!M)                             ;83BF94;      ; 
                       LDY.W #$0000                         ;83BF96;      ; 
                       LDA.B [$72],Y                        ;83BF99;000072; 
                       ORA.B #$40                           ;83BF9B;      ; 
                       STA.B [$72],Y                        ;83BF9D;000072; 
                       LDY.W #$0001                         ;83BF9F;      ; 
                       LDA.B [$72],Y                        ;83BFA2;000072; 
                       AND.B #$7F                           ;83BFA4;      ; 
                       STA.B [$72],Y                        ;83BFA6;000072; 
                       BRA CODE_83C01A                      ;83BFA8;83C01A; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
          CODE_83BFAA: %Set8bit(!M)                             ;83BFAA;      ; 
                       %Set16bit(!X)                             ;83BFAC;      ; 
                       LDY.W #$0000                         ;83BFAE;      ; 
                       LDA.B [$72],Y                        ;83BFB1;000072; 
                       AND.B #$40                           ;83BFB3;      ; 
                       BEQ CODE_83C01A                      ;83BFB5;83C01A; 
                       LDY.W #$0003                         ;83BFB7;      ; 
                       LDA.B [$72],Y                        ;83BFBA;000072; 
                       BEQ CODE_83BFCC                      ;83BFBC;83BFCC; 
                       DEC A                                ;83BFBE;      ; 
                       STA.B [$72],Y                        ;83BFBF;000072; 
                       LDA.L $7F1F12                        ;83BFC1;7F1F12; 
                       DEC A                                ;83BFC5;      ; 
                       STA.L $7F1F12                        ;83BFC6;7F1F12; 
                       BNE CODE_83C01A                      ;83BFCA;83C01A; 
                                                            ;      ;      ; 
          CODE_83BFCC: LDY.W #$0002                         ;83BFCC;      ; 
                       LDA.B [$72],Y                        ;83BFCF;000072; 
                       CMP.B #$27                           ;83BFD1;      ; 
                       BNE CODE_83C01A                      ;83BFD3;83C01A; 
                       %Set16bit(!M)                             ;83BFD5;      ; 
                       LDA.L $7F1F64                        ;83BFD7;7F1F64; 
                       ORA.W #$0008                         ;83BFDB;      ; 
                       STA.L $7F1F64                        ;83BFDE;7F1F64; 
                       %Set8bit(!M)                             ;83BFE2;      ; 
                       LDY.W #$0000                         ;83BFE4;      ; 
                       LDA.B [$72],Y                        ;83BFE7;000072; 
                       ORA.B #$80                           ;83BFE9;      ; 
                       AND.B #$BF                           ;83BFEB;      ; 
                       STA.B [$72],Y                        ;83BFED;000072; 
                       %Set8bit(!M)                             ;83BFEF;      ; 
                       LDA.B #$14                           ;83BFF1;      ; 
                       STA.L $7F1F2B                        ;83BFF3;7F1F2B; 
                       LDY.W #$0004                         ;83BFF7;      ; 
                       LDA.B [$72],Y                        ;83BFFA;000072; 
                       CMP.B #$60                           ;83BFFC;      ; 
                       BCC CODE_83C018                      ;83BFFE;83C018; 
                       CMP.B #$C0                           ;83C000;      ; 
                       BCC CODE_83C00E                      ;83C002;83C00E; 
                       %Set8bit(!M)                             ;83C004;      ; 
                       LDA.B #$64                           ;83C006;      ; 
                       STA.L $7F1F2B                        ;83C008;7F1F2B; 
                       BRA CODE_83C018                      ;83C00C;83C018; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
          CODE_83C00E: %Set8bit(!M)                             ;83C00E;      ; 
                       LDA.B #$32                           ;83C010;      ; 
                       STA.L $7F1F2B                        ;83C012;7F1F2B; 
                       BRA CODE_83C018                      ;83C016;83C018; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
          CODE_83C018: BRA CODE_83C01A                      ;83C018;83C01A; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
          CODE_83C01A: %Set16bit(!MX)                             ;83C01A;      ; 
                       PLX                                  ;83C01C;      ; 
                       INX                                  ;83C01D;      ; 
                       CPX.W #$000C                         ;83C01E;      ; 
                       BEQ CODE_83C026                      ;83C021;83C026; 
                       JMP.W CODE_83BE5B                    ;83C023;83BE5B; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
          CODE_83C026: %Set16bit(!MX)                             ;83C026;      ; 
          ...
          CODE_83C649: %Set16bit(!MX)                             ;83C649;      ; 
                       ...
                       JMP.W CODE_83C734                    ;83C654;83C734; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
          CODE_83C657: LDA.B $D2                            ;83C657;0000D2; 
                       AND.W #$0800                         ;83C659;      ; 
          ...
          CODE_83C734: %Set16bit(!MX)                             ;83C734;      ; 
                       ...
                       JMP.W CODE_83C806                    ;83C73F;83C806; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
          CODE_83C742: LDA.B $D2                            ;83C742;0000D2; 
                       AND.W #$0010                         ;83C744;      ; 
...
UNK_TableFunctionSelect: dw $CB69,$CB69,$CB69,$CB69,$D2E0,$D2E0,$D2E0,$D2E0;83CAA9;      ; 
      ...
      UNK_FuncInTable: %Set16bit(!MX)                             ;83CB69;      ; 
          ...
          CODE_83CE5B: %Set16bit(!MX)                             ;83CE5B;      ; 
                       ...
                       %Set16bit(!MX)                             ;83CE82;      ; 
                       LDA.B $D2                            ;83CE84;0000D2; 
                       ORA.W #$0040                         ;83CE86;      ; 
                       STA.B $D2                            ;83CE89;0000D2; 
                       %Set16bit(!MX)                             ;83CE8B;      ; 
                       LDA.W #$0000                         ;83CE8D;      ; 
          ...
          CODE_83CFF8: %Set16bit(!MX)                             ;83CFF8;      ; 
                       ...
                       %Set16bit(!MX)                             ;83D01F;      ; 
                       LDA.B $D2                            ;83D021;0000D2; 
                       ORA.W #$0040                         ;83D023;      ; 
                       STA.B $D2                            ;83D026;0000D2; 
                       %Set16bit(!MX)                             ;83D028;      ; 
                       LDA.W #$0000                         ;83D02A;      ; 
          ...
          CODE_83D060: %Set16bit(!MX)                             ;83D060;      ; 
                       ...
                       %Set16bit(!MX)                             ;83D0A1;      ; 
                       LDA.B $D2                            ;83D0A3;0000D2; 
                       ORA.W #$0040                         ;83D0A5;      ; 
                       STA.B $D2                            ;83D0A8;0000D2; 
                       %Set16bit(!MX)                             ;83D0AA;      ; 
                       LDA.W #$0000                         ;83D0AC;      ; 
          ...
          CODE_83D0B2: %Set16bit(!MX)                             ;83D0B2;      ; 
                       ...
                       %Set16bit(!MX)                             ;83D0EE;      ; 
                       LDA.B $D2                            ;83D0F0;0000D2; 
                       ORA.W #$0040                         ;83D0F2;      ; 
                       STA.B $D2                            ;83D0F5;0000D2; 
                       %Set16bit(!MX)                             ;83D0F7;      ; 
                       LDA.W #$0000                         ;83D0F9;      ; 
          ...
          CODE_83DE9A: RTS                                  ;83DE9A;      ; 
                       ...
                       %Set16bit(!MX)                             ;83DEC2;      ; 
                       LDA.B $D2                            ;83DEC4;0000D2; 
                       ORA.W #$0040                         ;83DEC6;      ; 
                       STA.B $D2                            ;83DEC9;0000D2; 
                       %Set16bit(!MX)                             ;83DECB;      ; 
                       LDA.W #$0000                         ;83DECD;      ; 
          ...
          CODE_83E504: %Set16bit(!MX)                             ;83E504;      ; 
                       LDA.W #$0800                         ;83E506;      ; 
                       EOR.W #$FFFF                         ;83E509;      ; 
                       AND.B $D2                            ;83E50C;0000D2; 
                       STA.B $D2                            ;83E50E;0000D2; 
                       %Set8bit(!M)                             ;83E510;      ; 
          ...
          CODE_83E74B: RTS                                  ;83E74B;      ; 
                       ...
                       %Set16bit(!MX)                             ;83EBD2;      ; 
                       LDA.B $D2                            ;83EBD4;0000D2; 
                       ORA.W #$0001                         ;83EBD6;      ; 
                       STA.B $D2                            ;83EBD9;0000D2; 
                       %Set16bit(!MX)                             ;83EBDB;      ; 
                       LDA.W #$0000                         ;83EBDD;      ; 
                       STA.B !player_action                            ;83EBE0;0000D4; 
                       %Set16bit(!MX)                             ;83EBE2;      ; 
                       LDA.W #$0000                         ;83EBE4;      ; 
                       STA.B $DA                            ;83EBE7;0000DA; 
                       %Set16bit(!MX)                             ;83EBE9;      ; 
                       LDA.W #$0000                         ;83EBEB;      ; 
                       ...
                       LDA.W #$0002                         ;83EC05;      ; 
                       EOR.W #$FFFF                         ;83EC08;      ; 
                       AND.B $D2                            ;83EC0B;0000D2; 
                       STA.B $D2                            ;83EC0D;0000D2; 
                       %Set8bit(!M)                             ;83EC0F;      ; 
          ...
          CODE_83F4D8: %Set16bit(!MX)                             ;83F4D8;      ; 
                       ...
                       LDX.W #$002E                         ;83F4DD;      ; 
                       LDY.W #$0000                         ;83F4E0;      ; 
                       JSL.L VIP                            ;83F4E3;848097; 
                       %Set16bit(!MX)                             ;83F4E7;      ; 
                       STZ.W $0196                          ;83F4E9;000196; 
                       LDA.L $7F1F5E                        ;83F4EC;7F1F5E; 
                       ORA.W #$0002                         ;83F4F0;      ; 
                       STA.L $7F1F5E                        ;83F4F3;7F1F5E; 
                       %Set8bit(!M)                             ;83F4F7;      ; 
                       LDA.B #$00                           ;83F4F9;      ; 
                       STA.L $7F1F47                        ;83F4FB;7F1F47; 
                       %Set8bit(!M)                             ;83F4FF;      ; 
                       %Set16bit(!X)                             ;83F501;      ; 
                       STZ.W $09B5                          ;83F503;0009B5; 
                       %Set16bit(!M)                             ;83F506;      ; 
                       LDA.W #$00B1                         ;83F508;      ; 
                       STA.W $0889                          ;83F50B;000889; 
                       STA.W $088B                          ;83F50E;00088B; 
                       STA.W $088D                          ;83F511;00088D; 
                       STA.W $088F                          ;83F514;00088F; 
                       LDX.W #$0000                         ;83F517;      ; 
                                                            ;      ;      ; 
          CODE_83F51A: %Set16bit(!MX)                             ;83F51A;      ; 
                       PHX                                  ;83F51C;      ; 
                       TXA                                  ;83F51D;      ; 
          ...
          CODE_83F53B: %Set8bit(!M)                             ;83F53B;      ; 
                       ...
                       STA.W $088F                          ;83F570;00088F; 
                                                            ;      ;      ; 
          CODE_83F573: %Set16bit(!MX)                             ;83F573;      ; 
                       PLX                                  ;83F575;      ; 
                       INX                                  ;83F576;      ; 
                       CPX.W #$000C                         ;83F577;      ; 
                       BNE CODE_83F51A                      ;83F57A;83F51A; 
