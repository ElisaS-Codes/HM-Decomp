...
BHHHH: ;8280AA
    ...
    .12pm:
       ...
       %Set16bit(!MX)                             ;82811E;      ; 
       LDA.B $D2                            ;828120;0000D2; 
       ORA.W #$0004                         ;828122;      ; 
       STA.B $D2                            ;828125;0000D2; 
       %Set16bit(!MX)                             ;828127;      ; 
       LDA.B $D2                            ;828129;0000D2; 
       ORA.W #$0400                         ;82812B;      ; 
       STA.B $D2                            ;82812E;0000D2; 
                                          ;      ;      ; 
     ...
     .dontResetSeason: %Set8bit(!M)                             ;8282EE;      ; 
      ...
      .dontResetMonth: %Set8bit(!M)                             ;8282F6;      ; 
          ...
          CODE_82837C: JSL.L $8095F5            ;82837C;8095F5; 
                       ...
                       JSL.L FindMostLovedandFillVariables  ;8283A8;828EC6; 
                       JSL.L CODE_828790                    ;8283AC;828790; 
                       %Set16bit(!M)                             ;8283B0;      ; 
                       STZ.W $0915                          ;8283B2;000915; 
                       STZ.B $D2                            ;8283B5;0000D2; 
                       ...
                       %Set16bit(!MX)                             ;8283C4;      ; 
                       LDA.B $D2                            ;8283C6;0000D2; 
                       ORA.W #$0001                         ;8283C8;      ; 
                       STA.B $D2                            ;8283CB;0000D2; 
                       %Set16bit(!MX)                             ;8283CD;      ; 
                       LDA.W #$0000                         ;8283CF;      ; 
                       STA.B !player_action                            ;8283D2;0000D4; 
                       %Set16bit(!MX)                             ;8283D4;      ; 
                       LDA.W #$0000                         ;8283D6;      ; 
                       STA.B $DA                            ;8283D9;0000DA; 
                       %Set16bit(!MX)                             ;8283DB;      ; 
                       LDA.W #$0000                         ;8283DD;      ; 
          ...
          CODE_828733: %Set8bit(!M)                             ;828733;      ; 
                       ...
                       LDA.W #$0002                         ;82873F;      ; 
                       EOR.W #$FFFF                         ;828742;      ; 
                       AND.B $D2                            ;828745;0000D2; 
                       STA.B $D2                            ;828747;0000D2; 
                       %Set16bit(!MX)                             ;828749;      ; 
                       LDA.W #$0088                         ;82874B;      ; 
                       ...
                       %Set16bit(!MX)                             ;828784;      ; 
                       LDA.B $D2                            ;828786;0000D2; 
                       ORA.W #$0004                         ;828788;      ; 
                       STA.B $D2                            ;82878B;0000D2; 
                                                            ;      ;      ; 
...
LoadsDateDataFromTables: %Set8bit(!M)                             ;8289D6;      ; 
  ...
  Table_UNK_FirstDays: db $12,$00,$13,$00,$0D,$00,$03,$00,$11,$00,$03,$00,$13,$00,$07,$00;828BF9;      ; 
         ...
         DATA8_828EC2: db $00,$00,$00,$08                   ;828EC2;      ; 
                                                            ;      ;      ; 
FindMostLovedandFillVariables: %Set16bit(!MX)                             ;828EC6;      ; 
                       LDY.W #$0000                         ;828EC8;      ; 
                       LDA.L !hearts_maria                        ;828ECB;7F1F1F;Hearts for Maria
                       STA.B $7E                            ;828ECF;00007E; 
                       LDX.W #$0002                         ;828ED1;      ; 
                                                            ;      ;      ; 
                .loop: %Set16bit(!MX)                             ;828ED4;      ; 
                       LDA.L !hearts_maria,X                      ;828ED6;7F1F1F; 
                       CMP.B $7E                            ;828EDA;00007E; 
                       BCS .morelove                        ;828EDC;828EE0; 
                       BRA .findnext                        ;828EDE;828EE7; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
            .morelove: %Set16bit(!MX)                             ;828EE0;      ; 
                       STA.B $7E                            ;828EE2;00007E; 
                       TXA                                  ;828EE4;      ; 
                       LSR A                                ;828EE5;      ; 
                       TAY                                  ;828EE6;      ; 
                                                            ;      ;      ; 
            .findnext: %Set16bit(!MX)                             ;828EE7;      ; 
                       INX                                  ;828EE9;      ; 
                       INX                                  ;828EEA;      ; 
                       CPX.W #$000A                         ;828EEB;      ; 
                       BNE .loop                            ;828EEE;828ED4; 
                       CPY.W #$0000                         ;828EF0;      ; 
                       BEQ .ifMaria                         ;828EF3;828F0C; 
                       CPY.W #$0001                         ;828EF5;      ; 
                       BEQ .ifNina                          ;828EF8;828F2D; 
                       CPY.W #$0002                         ;828EFA;      ; 
                       BEQ .ifAnn                           ;828EFD;828F4E; 
                       CPY.W #$0003                         ;828EFF;      ; 
                       BEQ .ifEllen                         ;828F02;828F6F; 
                       CPY.W #$0004                         ;828F04;      ; 
                       BNE .ifMaria                         ;828F07;828F0C; 
                       JMP.W .ifEve                         ;828F09;828F90; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
             .ifMaria: %Set16bit(!MX)                             ;828F0C;      ; 
                       LDA.W #$0026                         ;828F0E;      ; 
                       STA.W $08A1                          ;828F11;0008A1; 
                       LDA.W #$0000                         ;828F14;      ; 
                       STA.W $08A3                          ;828F17;0008A3; 
                       LDA.W #$0011                         ;828F1A;      ; 
                       STA.W $08A5                          ;828F1D;0008A5; 
                       LDA.W #$0008                         ;828F20;      ; 
                       STA.W $08A7                          ;828F23;0008A7; 
                       LDA.W #$0000                         ;828F26;      ; 
                       STA.W $08A9                          ;828F29;0008A9; 
                       RTL                                  ;828F2C;      ; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
              .ifNina: %Set16bit(!MX)                             ;828F2D;      ; 
                       LDA.W #$001A                         ;828F2F;      ; 
                       STA.W $08A1                          ;828F32;0008A1; 
                       LDA.W #$000D                         ;828F35;      ; 
                       STA.W $08A3                          ;828F38;0008A3; 
                       LDA.W #$000D                         ;828F3B;      ; 
                       STA.W $08A5                          ;828F3E;0008A5; 
                       LDA.W #$00B1                         ;828F41;      ; 
                       STA.W $08A7                          ;828F44;0008A7; 
                       LDA.W #$00B1                         ;828F47;      ; 
                       STA.W $08A9                          ;828F4A;0008A9; 
                       RTL                                  ;828F4D;      ; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
               .ifAnn: %Set16bit(!MX)                             ;828F4E;      ; 
                       LDA.W #$0027                         ;828F50;      ; 
                       STA.W $08A1                          ;828F53;0008A1; 
                       LDA.W #$0008                         ;828F56;      ; 
                       STA.W $08A3                          ;828F59;0008A3; 
                       LDA.W #$000D                         ;828F5C;      ; 
                       STA.W $08A5                          ;828F5F;0008A5; 
                       LDA.W #$0000                         ;828F62;      ; 
                       STA.W $08A7                          ;828F65;0008A7; 
                       LDA.W #$00B1                         ;828F68;      ; 
                       STA.W $08A9                          ;828F6B;0008A9; 
                       RTL                                  ;828F6E;      ; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
             .ifEllen: %Set16bit(!MX)                             ;828F6F;      ; 
                       LDA.W #$001E                         ;828F71;      ; 
                       STA.W $08A1                          ;828F74;0008A1; 
                       LDA.W #$000B                         ;828F77;      ; 
                       STA.W $08A3                          ;828F7A;0008A3; 
                       LDA.W #$000B                         ;828F7D;      ; 
                       STA.W $08A5                          ;828F80;0008A5; 
                       LDA.W #$0004                         ;828F83;      ; 
                       STA.W $08A7                          ;828F86;0008A7; 
                       LDA.W #$000D                         ;828F89;      ; 
                       STA.W $08A9                          ;828F8C;0008A9; 
                       RTL                                  ;828F8F;      ; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
               .ifEve: %Set16bit(!MX)                             ;828F90;      ; 
                       LDA.W #$001E                         ;828F92;      ; 
                       STA.W $08A1                          ;828F95;0008A1; 
                       LDA.W #$0015                         ;828F98;      ; 
                       STA.W $08A3                          ;828F9B;0008A3; 
                       LDA.W #$0004                         ;828F9E;      ; 
                       STA.W $08A5                          ;828FA1;0008A5; 
                       LDA.W #$00B1                         ;828FA4;      ; 
                       STA.W $08A7                          ;828FA7;0008A7; 
                       LDA.W #$00B1                         ;828FAA;      ; 
                       STA.W $08A9                          ;828FAD;0008A9; 
                       RTL                                  ;828FB0;      ;END_FindMostLovedandFillVariables
                                                            ;      ;      ; 
                                                            ;      ;      ; 
       ...
       RTL                                   
         ...
         Unk_Seasons2: %Set8bit(!M)                             ;82A811;      ; 
          ...
          CODE_82AEBA: %Set16bit(!M)                             ;82AEBA;      ; 
                       ...
                       %Set16bit(!MX)                             ;82AED5;      ; 
                       LDA.B $D2                            ;82AED7;0000D2; 
                       ORA.W #$0040                         ;82AED9;      ; 
                       STA.B $D2                            ;82AEDC;0000D2; 
                       %Set16bit(!MX)                             ;82AEDE;      ; 
                       LDA.W #$0000                         ;82AEE0;      ; 
          ...
          CODE_82AEE6: %Set16bit(!M)                             ;82AEE6;      ; 
                       ...
                       LDA.B $DA                            ;82AEF9;0000DA; 
                       JSL.L CBBBB                          ;82AEFB;83AD91; 
                       RTL                                  ;82AEFF;      ; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
                 WWWW: %Set16bit(!MX)                             ;82AF00;      ; 
                       LDY.W #$0000                         ;82AF02;      ; 
                                                            ;      ;      ; 
               .loop2: LDX.W #$0000                         ;82AF05;      ; 
                                                            ;      ;      ; 
               .loop1: PHY                                  ;82AF08;      ; 
                       PHX                                  ;82AF09;      ; 
                       STX.B $82                            ;82AF0A;000082; 
                       STY.B $84                            ;82AF0C;000084; 
                       JSR.W UNK_OperatesOnSeasonTable      ;82AF0E;82B13C; 
                       %Set8bit(!M)                             ;82AF11;      ; 
                       %Set16bit(!X)                             ;82AF13;      ; 
                       LDA.W $09B6,X                        ;82AF15;0009B6; 
                       BNE .skip1                           ;82AF18;82AF1D; 
                       JMP.W .jump2                         ;82AF1A;82B009; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
               .skip1: CMP.B #$A0                           ;82AF1D;      ; 
                       BCC .skip2                           ;82AF1F;82AF24; 
                       JMP.W .jump2                         ;82AF21;82B009; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
               .skip2: CMP.B #$73                           ;82AF24;      ; 
              ...
              .skip10: TYA                                  ;82B01B;      ; 
                       ...
                       JMP.W .loop2                         ;82B026;82AF05; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
              .return: RTL                                  ;82B029;      ;END_WWWW
                                                            ;      ;      ; 
                                                            ;      ;      ; 
         DATA8_82B02A: db $09,$02,$07,$01,$07,$04,$07,$04,$09,$03,$08,$02,$09,$06,$08,$05;82B02A;      ; 
          ...
          CODE_82B124: %Set16bit(!MX)                             ;82B124;      ; 
                       ...
                       RTL                                  ;82B13B;      ; 
                                                            ;      ;      ; 
                                                            ;      ;      ; 
UNK_OperatesOnSeasonTable: %Set16bit(!MX)                             ;82B13C;      ;Param in X and Y Returns in X
                       TXA                                  ;82B13E;      ; 
                       LSR A                                ;82B13F;      ; 
                       LSR A                                ;82B140;      ; 
                       LSR A                                ;82B141;      ; 
                       LSR A                                ;82B142;      ; 
                       STA.B $7E                            ;82B143;00007E;move X to High bite
                       TYA                                  ;82B145;      ; 
                       AND.W #$FFF0                         ;82B146;      ; 
                       STA.B $80                            ;82B149;000080;remove last 4 bits from Y
                       %Set8bit(!M)                             ;82B14B;      ; 
                       LDA.W $0181                          ;82B14D;000181;$7E0181
                       CMP.B #$01                           ;82B150;      ; 
                       BEQ .skip1                           ;82B152;82B16B;if $7E0181's 8 bit is reset
                       %Set16bit(!M)                             ;82B154;      ; 
                       LDA.B $80                            ;82B156;000080; 
                       ASL A                                ;82B158;      ; 
                       STA.B $80                            ;82B159;000080;Yx2
                       %Set8bit(!M)                             ;82B15B;      ; 
                       LDA.W $0181                          ;82B15D;000181;$7E0181
                       CMP.B #$02                           ;82B160;      ; 
                       BEQ .skip1                           ;82B162;82B16B;if $7E0181's 7 bit is reset
                       %Set16bit(!M)                             ;82B164;      ; 
                       LDA.B $80                            ;82B166;000080; 
                       ASL A                                ;82B168;      ; 
                       STA.B $80                            ;82B169;000080;Yx2
                                                            ;      ;      ; 
               .skip1: %Set16bit(!M)                             ;82B16B;      ; 
                       LDA.B $7E                            ;82B16D;00007E; 
                       CLC                                  ;82B16F;      ; 
                       ADC.B $80                            ;82B170;000080;Adds X and Y
                       TAX                                  ;82B172;      ; 
                       RTS                                  ;82B173;      ;END_UNK_OperatesOnSeasonTable
                                                            ;      ;      ; 
                                                            ;      ;      ; 
FarmMapPointerTable: dl $A78000,$A78000,$A78000,$A78000,$A79600,$A79600,$A79600,$A79600,$A7F000;82B173
         ...
         DATA8_82CFB4: db $00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$09,$09,$0A,$00;82CFB4;      ; 
          ...
          CODE_82D1C0: %Set8bit(!M)                             ;82D1C0;      ; 
                       ...
                       STZ.B $D2                            ;82D297;0000D2; 
                       STZ.B !player_action                            ;82D299;0000D4; 
                       %Set8bit(!M)                             ;82D29B;      ; 
                       %Set16bit(!MX)                             ;82D29D;      ; 
                       LDA.B $D2                            ;82D29F;0000D2; 
                       ORA.W #$0001                         ;82D2A1;      ; 
                       STA.B $D2                            ;82D2A4;0000D2; 
                       %Set16bit(!MX)                             ;82D2A6;      ; 
                       LDA.W #$0000                         ;82D2A8;      ; 
                       STA.B !player_action                            ;82D2AB;0000D4; 
                       %Set16bit(!MX)                             ;82D2AD;      ; 
                       LDA.W #$0000                         ;82D2AF;      ; 
                       STA.B $DA                            ;82D2B2;0000DA; 
                       %Set16bit(!MX)                             ;82D2B4;      ; 
                       LDA.W #$0000                         ;82D2B6;      ; 
                       ...
                       LDA.W #$0002                         ;82D2D6;      ; 
                       EOR.W #$FFFF                         ;82D2D9;      ; 
                       AND.B $D2                            ;82D2DC;0000D2; 
                       STA.B $D2                            ;82D2DE;0000D2; 
                       %Set16bit(!MX)                             ;82D2E0;      ; 
          ...
          CODE_82D3C7: %Set8bit(!M)                             ;82D3C7;      ; 
                       ...
                       STZ.B $D2                            ;82D498;0000D2; 
                       STZ.B !player_action                            ;82D49A;0000D4; 
                       %Set8bit(!M)                             ;82D49C;      ; 
                       %Set16bit(!MX)                             ;82D49E;      ; 
                       LDA.B $D2                            ;82D4A0;0000D2; 
                       ORA.W #$0001                         ;82D4A2;      ; 
                       STA.B $D2                            ;82D4A5;0000D2; 
                       %Set16bit(!MX)                             ;82D4A7;      ; 
                       LDA.W #$0000                         ;82D4A9;      ; 
                       STA.B !player_action                            ;82D4AC;0000D4; 
                       %Set16bit(!MX)                             ;82D4AE;      ; 
                       LDA.W #$0000                         ;82D4B0;      ; 
                       STA.B $DA                            ;82D4B3;0000DA; 
                       %Set16bit(!MX)                             ;82D4B5;      ; 
                       LDA.W #$0000                         ;82D4B7;      ; 
                       ...
                       LDA.W #$0002                         ;82D4D7;      ; 
                       EOR.W #$FFFF                         ;82D4DA;      ; 
                       AND.B $D2                            ;82D4DD;0000D2; 
                       STA.B $D2                            ;82D4DF;0000D2; 
                       %Set16bit(!MX)                             ;82D4E1;      ; 
    ...
    WaitNMI: 
       ...
       CODE_82D881: BRA WaitNMI                      ;82D881;82D80D;END_MainLoop?
          ...
          CODE_82D8B0: %Set16bit(!MX)                             ;82D8B0;      ; 
                       ...
                       %Set16bit(!M)                             ;82D8CE;      ; 
                       %Set16bit(!MX)                             ;82D8D0;      ; 
                       LDA.B $D2                            ;82D8D2;0000D2; 
                       ORA.W #$0001                         ;82D8D4;      ; 
                       STA.B $D2                            ;82D8D7;0000D2; 
                       %Set16bit(!MX)                             ;82D8D9;      ; 
                       LDA.W #$0000                         ;82D8DB;      ; 
                       STA.B !player_action                            ;82D8DE;0000D4; 
                       %Set16bit(!MX)                             ;82D8E0;      ; 
                       LDA.W #$0000                         ;82D8E2;      ; 
                       STA.B $DA                            ;82D8E5;0000DA; 
                       %Set16bit(!MX)                             ;82D8E7;      ; 
                       LDA.W #$0000                         ;82D8E9;      ; 
