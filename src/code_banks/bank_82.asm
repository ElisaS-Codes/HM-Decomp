...
SUB_82A6A2: ;82A6A2
    ...
    .CODE_82A6BB:
        ...
        %Set8bit(!M)                             ;82A6C4;      ;
        LDA.L !farm_map_array,X                      ;82A6C6;7EA4E6;
    ...
    .CODE_82A6E0:
        %Set8bit(!M)                             ;82A6E0;      ;
        LDA.B #$7A                           ;82A6E2;      ;
        STA.L !farm_map_array,X                      ;82A6E4;7EA4E6;
        BRA .CODE_82A6F2                      ;82A6E8;82A6F2;

    .CODE_82A6EA:
        %Set8bit(!M)                             ;82A6EA;      ;
        LDA.B #$07                           ;82A6EC;      ;
        STA.L !farm_map_array,X                      ;82A6EE;7EA4E6;
...
CHHHH: ;82A713
          ...
          CODE_82A72A: PHY                                  ;82A72A;      ;
                       ...
                       %Set8bit(!M)                             ;82A733;      ;
                       LDA.L !farm_map_array,X                      ;82A735;7EA4E6;
                       CMP.B #$A0                           ;82A739;      ;
          ...
          CODE_82A767: PHX                                  ;82A767;      ;
                       ...
                       LDA.B #$06                           ;82A775;      ;
                       STA.L !farm_map_array,X                      ;82A777;7EA4E6;
          ...
          CODE_82A784: %Set16bit(!MX)                             ;82A784;      ;
                       ...
                       LDA.B #$02                           ;82A798;      ;
                       STA.L !farm_map_array,X                      ;82A79A;7EA4E6;
                       %Set16bit(!M)                             ;82A79E;      ;
          ...
          CODE_82A7B8: %Set16bit(!MX)                             ;82A7B8;      ;
                       ...
                       LDA.B #$02                           ;82A7CC;      ;
                       STA.L !farm_map_array,X                      ;82A7CE;7EA4E6;
          ...
          CODE_82A7D4: %Set16bit(!MX)                             ;82A7D4;      ;
                       ...
                       LDA.B #$02                           ;82A7E8;      ;
                       STA.L !farm_map_array,X                      ;82A7EA;7EA4E6;
         ...
         Unk_Seasons2: %Set8bit(!M)                             ;82A811;      ;
          ...
          CODE_82A822: PHY                                  ;82A822;      ;
                       ...
                       %Set8bit(!M)                             ;82A82B;      ;
                       LDA.L !farm_map_array,X                      ;82A82D;7EA4E6;
          ...
          CODE_82A8C1: %Set8bit(!M)                             ;82A8C1;      ;
                       LDA.L !farm_map_array,X                      ;82A8C3;7EA4E6;
                       DEC A                                ;82A8C7;      ;
                       STA.L !farm_map_array,X                      ;82A8C8;7EA4E6;
          ...
          CODE_82A906: %Set8bit(!M)                             ;82A906;      ;
                       ...
                       LDA.L !farm_map_array,X                      ;82A910;7EA4E6;
                       INC A                                ;82A914;      ;
                       STA.L !farm_map_array,X                      ;82A915;7EA4E6;
...
CKKKK:
    ...
    .loop2:
       ...
       JSR.W GetTileIndex
       %Set8bit(!M)
       LDA.L !farm_map_array,X                       ;Farm data?
       CMP.B #$76
       BEQ .found
       CMP.B #$77
       BEQ .found
...
CLLLL: ;82AA0C
    ...
    .calculatemapusage:
        ...
        JSR.W GetTileIndex
        %Set8bit(!M)                             ;82AA2D;      ;
        LDA.L !farm_map_array,X                      ;82AA2F;7EA4E6;
        CMP.B #$A0                           ;82AA33;      ;
